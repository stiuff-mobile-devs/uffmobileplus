final Map<String, String> ptBR = {
  ...
  'desativar_modo_desenvolvedor' : 'DESATIVE O MODO DESENVOLVEDOR PARA ABRIR O APLICATIVO!',
  'erro' : 'Erro',
  'plataforma_nao_suportada' : 'Plataforma não suportada',
  'nao_foi_possivel_abrir_as_configuracoes' : 'Não foi possível abrir as configurações',
  ...
  'radio_description' : 'A Rádio Pop Goiaba/UFF, é um projeto de extensão da Universidade Fluminense, vinculada ao NUFEP - Núcleo Fluminense de Estudos e Pesquisas da UFF que é coordenado pelo professor Roberto Kant de Lima.',
